...
# Builds a maze based on a text format in the given file.txt.
def buildMaze( filename ):
    ...
    # Close the maze file.txt and return the newly constructed maze.
    infile.close()

    return maze

# Extracts an integer value pair from the given input file.txt.
